<?php
    $id = $url["1"];
    $slug = $url["2"];
    $postUrl = "https://noticiascidade.wsformasites.com.br/wp-json/wp/v2/posts/$id?categories=5";
    $curlInitForPost = curl_init($postUrl);
    curl_setopt($curlInitForPost, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($curlInitForPost, CURLOPT_SSL_VERIFYPEER, false);
    $post = json_decode(curl_exec($curlInitForPost));

    $latestPostsUrl = "https://noticiascidade.wsformasites.com.br/wp-json/wp/v2/posts?categories=5&per_page=6&exclude=$id&order=desc";
                        ...
                        <div class="related-posts">
                            ...
                            <?php foreach($latestPosts as $post) {?>
                                <div class="card" id="related-news">
                                    <a href="noticias-economia/<?php echo($post->id);?>/<?php echo($post->slug);?>">
                                        <div class="row">
